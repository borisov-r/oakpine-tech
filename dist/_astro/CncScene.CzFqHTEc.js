import"./disclose-version.DsnmJJEf.js";import{a0 as We,q as K,a1 as Ke,a2 as $e,a3 as Xe,k as qe,a4 as Qe,p as Je,a5 as et,c as tt,f as ae,a6 as it,a as $,h as nt,s as b,g as D,_ as ie,d as le,t as ot,j as pe,e as T,r as O,i as F}from"./template.C2LbZk_2.js";import{s as me}from"./render.P5kMZjEh.js";import{r as H}from"./attributes.BvKsa0aZ.js";import{a as rt,b as U,D as ee,V as _,S as we,M as V,R as De,O as at,d as E,B as ce,U as se,e as st,f as lt,g as te,L as ct,h as ht,i as G,j as Y,Q as Ae,k as Ne,P as dt,l as ut,m as ft,n as pt,o as mt,u as vt,T as A,p as _t,q as R,r as yt,s as xt,F as ze,t as gt,c as z,C as bt}from"./T.uCelvGNr.js";import{s as wt}from"./snippet.B588w_Yt.js";import{d as Dt,w as Re,p as St,s as Et,a as Pt,b as Mt,r as Ct}from"./props.H1WaZ1QE.js";import"./branches.C62shEpP.js";import"./if.BhszOLvk.js";function Z(t,e,i=e){var n=new WeakSet;We(t,"input",async o=>{var r=o?t.defaultValue:t.value;if(r=ve(t)?_e(r):r,i(r),K!==null&&n.add(K),await Ke(),r!==(r=e())){var a=t.selectionStart,s=t.selectionEnd,c=t.value.length;if(t.value=r??"",s!==null){var l=t.value.length;a===s&&s===c&&l>c?(t.selectionStart=l,t.selectionEnd=l):(t.selectionStart=a,t.selectionEnd=Math.min(s,l))}}}),(qe&&t.defaultValue!==t.value||$e(e)==null&&t.value)&&(i(ve(t)?_e(t.value):t.value),K!==null&&n.add(K)),Xe(()=>{var o=e();if(t===document.activeElement){var r=Qe??K;if(n.has(r))return}ve(t)&&o===_e(t.value)||t.type==="date"&&!o&&!t.value||o!==t.value&&(t.value=o??"")})}function ve(t){var e=t.type;return e==="number"||e==="range"}function _e(t){return t===""?null:+t}function Tt(t,e,i){const n=rt();if(!n)throw new Error("No user context store found, did you invoke this function outside of your main <Canvas> component?");return e?(n.update(o=>{if(t in o)return o;const r=typeof e=="function"?e():e;return o[t]=r,o}),n.current[t]):Dt(n,o=>o[t])}const L=t=>({subscribe:t.subscribe,get current(){return t.current}});let X=0;const Se=U(!1),he=U(!1),Ee=U(void 0),Pe=U(0),Me=U(0),Fe=U([]),Ce=U(0),{onStart:Ot,onLoad:It,onError:At}=ee;ee.onStart=(t,e,i)=>{Ot?.(t,e,i),he.set(!0),Ee.set(t),Pe.set(e),Me.set(i);const n=(e-X)/(i-X);Ce.set(n),n===1&&Se.set(!0)};ee.onLoad=()=>{It?.(),he.set(!1)};ee.onError=t=>{At?.(t),Fe.update(e=>[...e,t])};ee.onProgress=(t,e,i)=>{e===i&&(X=i),he.set(!0),Ee.set(t),Pe.set(e),Me.set(i);const n=(e-X)/(i-X)||1;Ce.set(n),n===1&&Se.set(!0)};L(he),L(Ee),L(Pe),L(Me),L(Fe),L(Ce),L(Se);new _;new _;new _;new we;new V;new De;new _;new _;new V;new _;new _;new at;new _;new _;new _;new E;const Nt="Right",zt="Top",Rt="Front",Lt="Left",kt="Bottom",Ut="Back";[Nt,zt,Rt,Lt,kt,Ut].map(t=>t.toLocaleLowerCase());new ce;new _;se.line={worldUnits:{value:1},linewidth:{value:1},resolution:{value:new E(1,1)},dashOffset:{value:0},dashScale:{value:1},dashSize:{value:1},gapSize:{value:1}};st.line={uniforms:lt.merge([se.common,se.fog,se.line]),vertexShader:`
		#include <common>
